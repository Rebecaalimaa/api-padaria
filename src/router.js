...
routes.patch('/funcionarios/:id',  Funcionario.update);
...
routes.get('/fornecedores/:id',  Fornecedor.readOne);
routes.post('/fornecedores',  Fornecedor.create);
routes.patch('/fornecedores/:id',  Fornecedor.update);
routes.delete('/fornecedores/:id',  Fornecedor.remove);
